...
export const Login = () => {
    ...
    return (
        <div className="bg-lego-pattern min-h-[100dvh] flex items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-x-hidden font-sans">
            ...
            {/* CARD PRINCIPAL */}
            <div className="w-full max-w-[90%] sm:max-w-md bg-white rounded-2xl sm:rounded-3xl shadow-2xl shadow-gray-300/50 relative z-10 overflow-hidden border border-gray-100 animate-login-card">
                ...
                <div className="p-6 sm:p-8 md:p-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                        ...
                        <div className="pt-2">
                            <button type="submit" className="w-full btn-lm-primary py-3 sm:py-3.5 rounded-xl font-semibold flex items-center justify-center gap-2">
                                CONECTAR
